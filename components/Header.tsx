...
const Header: React.FC<HeaderProps> = ({ activeView, setActiveView, householdName, onShowSettings, onLogout }) => {
  const getTabClass = (view: View) => {
    return activeView === view
      ...
      : 'text-gray-600 hover:bg-[#84A98C]/20 hover:text-[#73957a]';
  };
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#84A98C]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="flex items-center space-x-3">
            <button 
              ...
              aria-label="Configuración de la casa"
              data-tour-id="step-1-settings-button"
            >
        ...
        <div className="flex justify-center bg-[#f3f0e7] p-1 rounded-lg">
          <button
          ...
          <button
            ...
            data-tour-id="step-7-shopping-list-tab"
          >
            Comprar
          </button>
        </div>
